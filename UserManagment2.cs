...
namespace RestaurantPOS
{
    public partial class UserManagment2 : UserControl
    {
        ...
        private void btnAddUser_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection("Data Source=DESKTOP-D87KK1G; Initial Catalog=RestaurantPOS; Integrated Security=True;"))
        ...
        {
            string currentUsername = txtUsername.Text.Trim(); // Current username
            string newPassword = txtPassword.Text.Trim(); // New password (if changed)
            bool isAdmin = chkAdmin.Checked;
